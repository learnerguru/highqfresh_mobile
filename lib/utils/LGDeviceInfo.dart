...
class LGDeviceInfo{
  ...
  static Future<void> initPlatformState() async {
    ...
    print(deviceData["version.sdkInt"]);
    print(deviceData["brand"]);
    print(deviceData["device"]);
    print(deviceData["model"]);
    print(deviceData["androidId"]);
    LgConstant.device_info =deviceData;
    print(LgConstant.device_info["androidId"]);
    LGSharedPrefernces.setServerPrefs(SharedPref.deviceData, json.encode(LgConstant.device_info));
