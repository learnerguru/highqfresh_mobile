...
class User {
  ...
  User.fromJson(Map<String, dynamic> json) {
    ...
    address = EncryptDecryptHelper.DecryptDatas(json['address']);
    appVersion = json['app_version'];
    birthDate =  EncryptDecryptHelper.DecryptDatas(json['birth_date']);
    dateCreated = json['date_created'];
    dateModified = json['date_modified'];
    emailId =  EncryptDecryptHelper.DecryptDatas(json['email_id']);
    emailVerifiedStatus = json['email_verified_status'];
    fName = EncryptDecryptHelper.DecryptDatas(json['f_name']);
    gender = json['gender'];
    instituteId = json['institute_id'];
    lName =  EncryptDecryptHelper.DecryptDatas(json['l_name']);
    ...
    password = EncryptDecryptHelper.DecryptDatas(json['password']);
    phone =  EncryptDecryptHelper.DecryptDatas(json['phone']);
    phoneVerifiedStatus = json['phone_verified_status'];
    profileImage = json['profile_image'];
    userCategory = json['user_category'];
    userName = EncryptDecryptHelper.DecryptDatas(json['user_name']);
